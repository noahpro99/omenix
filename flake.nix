{
  ...
  outputs = { nixpkgs, ... }:
    let
      ...
      # Helper script for fan control - single definition
      fanControlScript = ''
        #!/bin/bash
      ...
      # Create helper script package
      omenix-fancontrol = pkgs.writeShellScript "omenix-fancontrol" fanControlScript;

      # Polkit policy - single definition
      ...
      omenix = pkgs.rustPlatform.buildRustPackage {
        ...
        buildInputs = with pkgs; [ gtk3 libappindicator-gtk3 libayatana-appindicator polkit xdotool ];
    ...
    in
    {
        ...
        in
        {
          ...
          config = lib.mkIf cfg.enable {
            ...
            environment.etc."polkit-1/actions/com.omenix.fancontrol.policy".source =
              "${polkit-policy}/share/polkit-1/actions/com.omenix.fancontrol.policy";
            environment.etc."omenix/omenix-fancontrol".source = omenix-fancontrol;
      ...
      devShells.${system}.default = pkgs.mkShell {
        buildInputs = with pkgs; [
          gtk3 libappindicator-gtk3 libayatana-appindicator polkit xdotool
        ];

        nativeBuildInputs = with pkgs; [
          cargo rustc rust-analyzer clippy gcc openssl pkg-config
        ];
